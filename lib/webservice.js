  ...
  if(format == 'html'){
    ...
    for(var method in items){
     ...
     if(items[method].restful == true){
       restful += '<br/> this method is restful.'
       restful += '<br/> POST to /users/:id will create a new ' + method + ' resource';
       restful += '<br/> GET to /users will return all' + method;
       restful += '<br/> GET to /users/:id will return ' + method  + ' based on :id';
       restful += '<br/> PUT to /users/:id will update that ' + method;
       restful += '<br/> DELETE to /users/:id will delete that ' + method;
     }  
