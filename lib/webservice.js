...
var createHandler = exports.createHandler = function ( module ){
  var router = generateRouter( module );
...
function generateRouter( module ){
  ...
  var routes = {};
    ...
    for(var method in module){
      ...
      try{
        ...
        /* gotta comment this out for now
  ...
  var router = new(journey.Router)(function (map) {
    ...
    map.get('/version').bind(function (res) {
       ...
       /* For now, we will just hide the method call from the docs 

       // if the module is private, ignore it
       if(modules[module].private === true){
         continue;
       }
       ...
       */
           ...
           for(var method in module){
               ...
               var handler = function (res, resource) {
                 var args = [];
                 
                 // coherse method into string for integers
                 resource = resource.toString(); // Remark : i'm not sure method would be a Number at this point, its strange. maybe its the router?
