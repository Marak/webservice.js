        ...
        map.path(regex, function () {
          ...
          for(var m in modules[module]){
            ...
            (function(m, mm){
              ...
              var handler = function (res, resource, method, id, params) {
              ...
              var regexfix = new RegExp('\/' + m); 
              
              self.route(regex).bind(handler);
              self.route(regexfix).bind(handler);
